              ...
              <div class="blockElement imageAlignSide imageAlignRight twoByGridBlock">
                <div class="blockContent">
                  <h2>
                    <div>
                      <span>
                        <p>Recraft Dating App</p>
                      </span>
                    </div>
                  </h2>
                  <div>
                    <span>
                      <p>This dating app is a boilerplate for any react native developer who wants to build a dating app. The goal of this boilerplate is to provide a fully functional dating app which can be reused with very little to no modification.</p>
                      ...
                      <div className="inner">
                        <PromoSection>
                          ...
                          <Button target="_blank" href={docUrl('')}>Docs</Button>
                        </PromoSection>
                      </div>
                    </span>
                  </div>
